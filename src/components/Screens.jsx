      ...
      <Sec icon="Info" title="Sobre o sistema" desc="Informações e versão" color="#6B7A90">
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div style={{ flex: 1, font: "400 12.5px/1.6 var(--font-sans)", color: "var(--fg-2)" }}>
            ...
            Versão {window.__APP_VERSION__ || "1.0"} · Desenvolvido por <b>Matheus Proensa</b> (Ex Cb Proensa · DTCEA-SM).
          </div>
        </div>
      </Sec>
    </div>
...
function Guia({ setView }) {
  const T = [
    ...
    { id: "cadastros", icon: "Tags", title: "Cadastros", lead: "Organize a estrutura do almoxarifado.", steps: ["Crie, edite e exclua Categorias, Unidades de medida e Locais/Corredores.", "Gerencie os Responsáveis — militares que aparecem como opção ao registrar entradas e ajustes.", "Gerencie os Setores/Destinos — seções que aparecem como destino nas saídas (APP, TWR, SMST…).", "O que você criar aqui passa a valer em todo o sistema imediatamente."] },
